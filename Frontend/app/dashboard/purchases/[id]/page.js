  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl p-6 w-full max-w-sm mx-4">
        ...
        <h3 className="text-base font-semibold text-gray-900 mb-1">Delete this purchase?</h3>
        <p className="text-sm text-gray-500 mb-2">This purchase record and all linked inventory units will be permanently deleted.</p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-2xl p-6 w-full max-w-sm mx-4">
        ...
        <p className="text-sm text-gray-500 mb-2">
          ...
          {unitData?.plot_no ? ` · Plot ${unitData.plot_no}` : ''} will be permanently deleted.
        </p>
        <p className="text-sm font-medium text-red-600 bg-red-50 border border-red-100 rounded-lg px-3 py-2 mb-5">This action cannot be undone — deleted data cannot be recovered.</p>
        <div className="flex gap-2">
          <button onClick={onClose} className="flex-1 h-9 text-sm border border-gray-200 rounded-lg text-gray-600 hover:bg-gray-50 font-medium">Cancel</button>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm px-6 py-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-semibold ring-1 ${TYPE_RING[form.type] || TYPE_RING.PLOT}`}>{TYPE_MAP[form.type] || form.type}</span>

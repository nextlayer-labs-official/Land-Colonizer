...
const { getSales, getSaleById, createSale, updateSale, archiveSale, unarchiveSale, deleteSale, updateAdvancePayment } = require('./sales.controller');
...
router.patch('/:id/advance',   authorize('SALE_EDIT'),     updateAdvancePayment);
